...
class OtherUserProfileScreen extends GetView<OtherProfileController> {
  ...
  Widget buildCarDetail(OtherProfileController controller,
    ...
    return SingleChildScrollView(
        child: Padding(
          ...
          child: Column(children: [
              ...
              child: Center(
                child: Container(
                    ...
                    child: SizedBox(
                      child:
                      Obx(() =>
                      controller.isImage.value == true ? SizedBox(
                        width: 200,
                        child: CircleAvatar(
                          child: Image.file(
                          ...
                          '${AppConstant.assestPath}profile_icon.png')),
                    )),
              ),
            ...
            15.hSpace,
            labelTextRegular(
                controller.userName.value, 15, ThemeColor.darkTextColor),
            SizedBox(
              height: 20,
            ),
            Obx(() => controller.isLoading.value == true ?  SizedBox(
              ...
              child: RoundedButton(
                ...
                onTap: () {
                  print("Request"+ controller.requestStatus.toString());
  ...
  Widget buildVehicleDetail(int index, BuildContext context, OtherProfileController controller,) {
    return InkWell(
      ...
      onTap: () {
        if (index == 0) {
          print("Pos" + "Pos");
          Get.toNamed(
              Routes.myBlog, arguments: {"isData": true, "title": "Test"});
        }
        if (index == 3) {
          print("Logout""Logout");
        }
              ...
              children: [
                ...
                Expanded(
                  child: labelTextLight(
                      controller.listProfileData[index].titles, 14,
                      ThemeColor.darkTextColor),
                ),
                controller.totalMyPost.value > 0 ?
                labelTextBold(controller.totalMyPost.value.toString(), 14,
